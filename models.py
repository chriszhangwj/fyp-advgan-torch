...
class Target_C(nn.Module): # targeted model
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 32, kernel_size=3) # input channel size, output channel size, kernel size
...
class Target_A(nn.Module): # targeted model
    def __init__(self):
        super(Target_A, self).__init__()
...
class Generator(nn.Module):
    def __init__(self,
        ...
        bottle_neck_lis = [ResnetBlock(32), # r32
                       ResnetBlock(32),     # r32 
                       ResnetBlock(32),     # r32
                       ResnetBlock(32),]    # r32
